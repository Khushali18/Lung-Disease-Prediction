...
def create_cnn_model():
    ...
    3 Convolutional layers using 32, 64, 128 3x3 filters respectively and one fully connected layer
...
def prepare_data_for_cnn_model(X_train, y_train, X_test, y_test, batch_size=32):
    """
...
def train_cnn_model(model, train_generator, test_generator, epochs=20, model_path='cnn_model.h5'):
    """"
...
def evaluate_model(model_path, generator):
    """
    Function to evaluate CNN model and displays confusion matrix
    Args:
